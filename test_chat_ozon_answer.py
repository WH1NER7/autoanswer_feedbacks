...
Ваша информация принята в работу и передана в отдел технической поддержки. Ответ на ваш запрос поступит в оперативно в течение 1–2 часов с понедельника по пятницу с 9:00 до 18:00. В выходные дни ответ может задержаться до нескольких часов.\n\
Не спешите оформлять возврат и отказываться от товара. По внутренней статистике, мы решаем 95% всех обращений по неполадкам, и все решения выносим в пользу покупателя.\n\
