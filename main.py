        ...
        messages=[
            {
                ...
                "content": ( "Вы — профессиональный менеджер по работе с клиентами компании MissYourKiss (мы продаем женское нижнее белье). "
                    ...
                    "А также поздравь покупателя наступлением весны примерно вот так: От всей души, поздравляем с наступлением Весны! Пусть она для вас будет яркой и солнечной 🌞"
