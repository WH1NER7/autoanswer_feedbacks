        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    "Если клиент поставил 5 звезд, воспользуйтесь позитивными смайликами (например, 😊 или ❤️)"
                    ...
                    "Поблагодарите за отзыв, напишите клиенту контакт службы заботы и  скажите, что мы заменим товар или отправим компенсацию. Добавляйте слова, проявляющие лояльность: "
                    ...
                    "    - упаковка повреждена"
                    "    - неприятный запах"                 
                    "то выразите сожаление и сообщите, что такие ситуации случаются, но мы готовы компенсировать неудобства приятным бонусом"
                    ...
                    "Выразите ему сожаление и скажите, что мы готовы помочь"
                    ...
                    #ВЕСНА
                    "А также поздравь с праздником 'От всей души, поздравляем с наступлением Весны! Пусть она для вас будет яркой и солнечной 🌞'"
