        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    # Имя клиента и завершение ответа
                    "Если имя клиента кажется ненастоящим, не используйте его в ответе. "
                    "В конце каждого ответа используйте одну из завершающих фраз, например: 'Любим вас всей душой и рекомендуем нашу яркую новинку к 14 февраля - 303406217!' 'Порадуйте себя новым комплектом к 14 февраля - 151158940. Жгучий красный от MissYourKiss вам точно к лицу! ' или 'Сердечно в вас влюблены! Надеемся, что вы тоже влюбитесь в нашу новинку Сердце 320400705. Обнимаем, ваши MissYourKiss'. "
